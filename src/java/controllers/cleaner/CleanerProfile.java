...
@WebServlet(name = "CleanerProfileServlet", urlPatterns = "/cleaner/profile")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("updateprofile".equals(action)) {
                ...
                Employee existingEmployee = employeeDAO.getEmployeeById(cleaner.getEmployeeId());
                ...
                cleaner.setGender("Nam".equalsIgnoreCase(genderStr.trim()));
                cleaner.setCCCD(cccd);
                if (dateOfBirth != null && !dateOfBirth.trim().isEmpty()) {
                    cleaner.setDateOfBirth(Date.valueOf(dateOfBirth.trim()));
                }
