...
//            }
            ...
            if (customerByEmail == null) {
                ...
                dal.CustomerDAO.getInstance().updatePhoneNumberAndGender(checkCustomer);
...
//            dal.CartDAO.getInstance().updateStatusAndIsPayment(cart);
            ...
            if (status.equals("checkIn")) {
                ...
                totalPrice = totalAmount.subtract(paidAmount);
        ...
        long amount = totalPrice.multiply(BigInteger.valueOf(100)).longValue();
