...
=======
            <a href="${pageContext.request.contextPath}/view/receptionist/receptionistProfile" class="text-decoration-none text-reset"><i class="bi bi-person-circle"></i>Profile</a><br>
>>>>>>> origin/HaiLong25
