...
<html lang="en">
    ...
    <body style="background-color: #f4f4f4; font-family: Arial, sans-serif; margin: 0; padding: 20px;">
        ...
        <c:if test="${pageChange == 'checkOut'}">
            <div onclick="location.href = '${pageContext.request.contextPath}/receptionist/receipt'" style="cursor:pointer;">
                Xem hóa đơn (Check-out)
            </div>
        </c:if>

        <c:if test="${pageChange == 'checkIn'}">
            <div onclick="location.href = '${pageContext.request.contextPath}/receptionist/stayingRoom'" style="cursor:pointer;">
