        ...
        <div class="container mt-4">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <!-- Profile Form -->
                    <form action="${pageContext.request.contextPath}/view/admin/managerProfile" method="post" id="profileForm">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <c:if test="${isEditing}">
                                ...
                                <a href="${pageContext.request.contextPath}/view/admin/managerProfile" class="btn btn-secondary">Cancel</a>
                            </c:if>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="${pageContext.request.contextPath}/view/admin/managerProfile" method="post" onsubmit="return validatePasswordForm()">
                                        <input type="hidden" name="employeeId" value="${manager.employeeId}">
                                        <div class="mb-3">
